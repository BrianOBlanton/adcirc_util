% This is slightly modified version of ExtractGrid that specifies the
% reference lon, lat (lamda0,phi0) for the CPP Projection rather than using
% the mean values in the input file
%
%  2/4/2022  - RL

function TheGrid=ExtractGrid1(NcTBHandle)
...
if ConvertToCart
    ...
    [temp.x,temp.y]=AdcircCppForward(lon,lat,lamda0,phi0);
