function Var2netCDF(fem_grid_struct,v,t,varargin) 
...
%          v - array to write.  Must be size [fem_grid_struct.nn X ntimes]
...
%
%   CALL : Var2netCDF(fem_grid_struct,v,t,p1,v1,...)
%
...
VarID = netcdf.defVar(ncid,'newvar', 'double', [DimNod DimTim]);
...
for i=1:length(tsecs)
    ...
    netcdf.putVar(ncid,VarID,[0 i-1],[NN 1],v(i,:));
end
